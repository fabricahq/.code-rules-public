...
---
<!-- release-planner:generated v0.3.2 sha256:3a43474608424f23. Do not edit; change .release-planner/config.yml and run release-planner install. -->

# Prepare a release

This repository publishes releases with [Release Planner](https://github.com/fabricahq/release-planner) v0.3.2. Print its release procedure and follow it:
