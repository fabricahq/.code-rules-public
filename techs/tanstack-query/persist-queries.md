---
title: "persist-queries: Configure Query Persistence for Offline Support"
whenToRead: "Before retaining a TanStack Query cache across reloads for offline use or faster startup."
impact: "LOW"
impactDescription: "restores cached server state across reloads for offline support and faster startup"
tags: "tanstack-query, offline, persistence, cache, storage"
attribution: [{"url":"https://github.com/DeckardGer/tanstack-agent-skills/blob/0e8bcdc6af4959739e0f6a2dfb35dc70d513940a/skills/tanstack-query/rules/persist-queries.md","description":"Underlying tanstack-agent-skills material at skills/tanstack-query/rules/persist-queries.md, commit 0e8bcdc6af4959739e0f6a2dfb35dc70d513940a; adapted under MIT, with notice retained in the public library."}]
---
...
Source: [TanStack Agent Skills - tanstack-query/persist-queries.md](https://github.com/DeckardGer/tanstack-agent-skills/blob/0e8bcdc6af4959739e0f6a2dfb35dc70d513940a/skills/tanstack-query/rules/persist-queries.md). Adapted with attribution; see the [public library notice](https://github.com/fabricahq/.code-rules-public/blob/main/NOTICE.md).
