---
title: "qk-hierarchical-organization: Organize Keys Hierarchically"
whenToRead: "Before designing TanStack Query key prefixes that must support both broad and targeted invalidation."
impact: "MEDIUM"
impactDescription: "keeps query keys structured from broad entity scope to specific filters for targeted invalidation"
tags: "tanstack-query, query-keys, hierarchy, filters, invalidation"
attribution: [{"url":"https://github.com/DeckardGer/tanstack-agent-skills/blob/0e8bcdc6af4959739e0f6a2dfb35dc70d513940a/skills/tanstack-query/rules/qk-hierarchical-organization.md","description":"Underlying tanstack-agent-skills material at skills/tanstack-query/rules/qk-hierarchical-organization.md, commit 0e8bcdc6af4959739e0f6a2dfb35dc70d513940a; adapted under MIT, with notice retained in the public library."}]
---
...
Source: [TanStack Agent Skills - tanstack-query/qk-hierarchical-organization.md](https://github.com/DeckardGer/tanstack-agent-skills/blob/0e8bcdc6af4959739e0f6a2dfb35dc70d513940a/skills/tanstack-query/rules/qk-hierarchical-organization.md). Adapted with attribution; see the [public library notice](https://github.com/fabricahq/.code-rules-public/blob/main/NOTICE.md).
