---
title: "load-parallel: Leverage Parallel Route Loading"
whenToRead: "Before structuring nested TanStack Router loaders whose independent requests could run concurrently."
impact: "MEDIUM"
impactDescription: "avoids artificial data-loading waterfalls across route boundaries"
tags: "tanstack-router, loaders, parallel-loading, waterfalls, performance"
attribution: [{"url":"https://github.com/DeckardGer/tanstack-agent-skills/blob/0e8bcdc6af4959739e0f6a2dfb35dc70d513940a/skills/tanstack-router/rules/load-parallel.md","description":"Underlying tanstack-agent-skills material at skills/tanstack-router/rules/load-parallel.md, commit 0e8bcdc6af4959739e0f6a2dfb35dc70d513940a; adapted under MIT, with notice retained in the public library."}]
---
...
Source: [TanStack Agent Skills - tanstack-router/load-parallel.md](https://github.com/DeckardGer/tanstack-agent-skills/blob/0e8bcdc6af4959739e0f6a2dfb35dc70d513940a/skills/tanstack-router/rules/load-parallel.md). Adapted with attribution; see the [public library notice](https://github.com/fabricahq/.code-rules-public/blob/main/NOTICE.md).
