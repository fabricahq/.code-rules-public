---
title: "cache-single-source: Let TanStack Query Manage Caching"
whenToRead: "Before combining TanStack Router loaders or preloading with TanStack Query caching for the same server data."
impact: "MEDIUM"
impactDescription: "keeps TanStack Query as the authoritative cache by making Router preloading defer freshness decisions"
tags: "tanstack-router, tanstack-integration, tanstack-query, cache, preloading"
attribution: [{"url":"https://github.com/DeckardGer/tanstack-agent-skills/blob/0e8bcdc6af4959739e0f6a2dfb35dc70d513940a/skills/tanstack-integration/rules/cache-single-source.md","description":"Underlying tanstack-agent-skills material at skills/tanstack-integration/rules/cache-single-source.md, commit 0e8bcdc6af4959739e0f6a2dfb35dc70d513940a; adapted under MIT, with notice retained in the public library."}]
---
...
Source: [TanStack Agent Skills - tanstack-integration/cache-single-source.md](https://github.com/DeckardGer/tanstack-agent-skills/blob/0e8bcdc6af4959739e0f6a2dfb35dc70d513940a/skills/tanstack-integration/rules/cache-single-source.md). Adapted with attribution; see the [public library notice](https://github.com/fabricahq/.code-rules-public/blob/main/NOTICE.md).
