---
title: "ctx-root-context: Define Context at Root Route"
whenToRead: "Before giving TanStack Router loaders typed access to shared dependencies such as a query client or auth state."
impact: "LOW"
impactDescription: "makes router services and auth state typed, injectable, and testable"
tags: "tanstack-router, router-context, dependency-injection, query-client, auth"
attribution: [{"url":"https://github.com/DeckardGer/tanstack-agent-skills/blob/0e8bcdc6af4959739e0f6a2dfb35dc70d513940a/skills/tanstack-router/rules/ctx-root-context.md","description":"Underlying tanstack-agent-skills material at skills/tanstack-router/rules/ctx-root-context.md, commit 0e8bcdc6af4959739e0f6a2dfb35dc70d513940a; adapted under MIT, with notice retained in the public library."}]
---
...
Source: [TanStack Agent Skills - tanstack-router/ctx-root-context.md](https://github.com/DeckardGer/tanstack-agent-skills/blob/0e8bcdc6af4959739e0f6a2dfb35dc70d513940a/skills/tanstack-router/rules/ctx-root-context.md). Adapted with attribution; see the [public library notice](https://github.com/fabricahq/.code-rules-public/blob/main/NOTICE.md).
