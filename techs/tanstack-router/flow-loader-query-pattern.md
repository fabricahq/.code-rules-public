---
title: "flow-loader-query-pattern: Use Loaders with ensureQueryData"
whenToRead: "Before coordinating TanStack Router loaders with TanStack Query prefetching and Suspense reads in route components."
impact: "HIGH"
impactDescription: "eliminates component-fetch waterfalls by preloading TanStack Query data in Router loaders"
tags: "tanstack-router, tanstack-integration, tanstack-query, loaders, ensure-query-data"
attribution: [{"url":"https://github.com/DeckardGer/tanstack-agent-skills/blob/0e8bcdc6af4959739e0f6a2dfb35dc70d513940a/skills/tanstack-integration/rules/flow-loader-query-pattern.md","description":"Underlying tanstack-agent-skills material at skills/tanstack-integration/rules/flow-loader-query-pattern.md, commit 0e8bcdc6af4959739e0f6a2dfb35dc70d513940a; adapted under MIT, with notice retained in the public library."}]
---
...
Source: [TanStack Agent Skills - tanstack-integration/flow-loader-query-pattern.md](https://github.com/DeckardGer/tanstack-agent-skills/blob/0e8bcdc6af4959739e0f6a2dfb35dc70d513940a/skills/tanstack-integration/rules/flow-loader-query-pattern.md). Adapted with attribution; see the [public library notice](https://github.com/fabricahq/.code-rules-public/blob/main/NOTICE.md).
