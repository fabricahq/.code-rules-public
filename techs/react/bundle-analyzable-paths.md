...
whenToRead: "Before building dynamic imports or filesystem paths that a React build tool must analyze."
impact: "HIGH"
impactDescription: "avoids accidental broad bundles and file traces"
tags: "react, performance, bundle, nextjs, vite, webpack, rollup, esbuild, path"
...
Source: [Vercel Agent Skills - react-best-practices/bundle-analyzable-paths.md](https://github.com/vercel-labs/agent-skills/blob/4ec6f84b61cd3c931046c3e6e398f3ae7de372f7/skills/react-best-practices/rules/bundle-analyzable-paths.md). Adapted with attribution.
